function [objective,grad,info] = ...
    evaluate_poisson_reduced_fast_tanh(p,cache,lambda,ls_opts)
%EVALUATE_POISSON_REDUCED_FAST_TANH Fast analytic tanh Poisson evaluator.
%
...
% Full dM matrices are not stored; only (dM/dp_k)*w is formed.
    ...
    vB1 = ...
        cache.eta*((Tbp.*cache.Qb1)*w);

    vB2 = ...
        cache.eta*((Tbp.*cache.Qb2)*w);
