function [objective,grad,info] = ...
    evaluate_poisson_reduced_fast_sin(p,cache,lambda,ls_opts)
%EVALUATE_POISSON_REDUCED_FAST_SIN Fast analytic sine Poisson evaluator.
%
% Same cached/analytic structure as evaluate_poisson_reduced_fast.m.
% Full dM matrices are not stored; only (dM/dp_k)*w is formed.
    ...
    vB1 = ...
        cache.eta*((Sin_bp.*cache.Qb1)*w);

    vB2 = ...
        cache.eta*((Sin_bp.*cache.Qb2)*w);
