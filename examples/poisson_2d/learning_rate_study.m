...
%% ========================================================================
%  AD-RaNN learning-rate sensitivity study
%
...
%      learning_rate_study
%
%  The experiment changes ONLY the Adam learning rate.
%
%  Common settings:
%      p0             = (4,8)
%      m              = 600
...
if isempty(this_file)
    error('Please save this file as learning_rate_study.m before running it.');
end
...
output_dir = fullfile(example_dir,'learning_rate_study_results');
...
checkpoint_file = fullfile( ...
    output_dir, ...
    'learning_rate_study_checkpoint.mat');

result_mat_file = fullfile( ...
    output_dir, ...
    'learning_rate_study_results.mat');

summary_csv_file = fullfile( ...
    output_dir, ...
    'learning_rate_study_summary.csv');

detail_csv_file = fullfile( ...
    output_dir, ...
    'learning_rate_study_all_runs.csv');
...
if exist(checkpoint_file,'file') == 2
    ...
    try
        ...
        warning('Checkpoint could not be loaded: %s',ME.message);
...
fprintf('\n');
fprintf('======================================================================\n');
fprintf('             AD-RaNN learning-rate sensitivity study\n');
fprintf('======================================================================\n');
fprintf('p0             = [%.3f, %.3f]\n',p0(1),p0(2));
